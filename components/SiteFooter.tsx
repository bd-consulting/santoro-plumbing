  ...
  return (
    <footer className="mt-20 border-t">
      <div className="container py-12 grid gap-10 md:grid-cols-3">
        <div>
          <div className="font-semibold">Santoro Plumbing &amp; Well Services, LLC</div>
          <p className="mt-2 text-sm text-slate-600">
            Prospect, CT 06712
            <br />
            <Link className="underline" href={PHONE_TEL}>
              {PHONE_TEXT}
            </Link>
          </p>
      ...
      <div className="border-t">
        <div className="container py-5 text-xs text-slate-500 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
